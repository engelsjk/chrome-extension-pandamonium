...
var GiphySearch = {
    ...
    init_extension:function() {
        ...
        $(document.body).on("click", "#gif-detail-link", function(event) {
            // copy to clipboard..
            var $this = $(this);
        ...
        chrome.contextMenus.onClicked.addListener(function(info, tab) {
          ...
          if(info.menuItemId === "giphy_img_src_menu") {
            ...
            elem_params.value = GiphySearch.drawEmbedCode(gif_obj.id);
          }
    ...
    drawEmbedCode:function(gif_id) {
        var embed_str = '<div style="max-width: 500px;" id="_giphy_%(gif_id)s"></div>'
        embed_str +="<script>var _giphy = _giphy || []; _giphy.push({id: '%(gif_id)s',w: 500, h: 285});var g = document.createElement('script'); g.type = 'text/javascript'; g.async = true;g.src = ('https:' == document.location.protocol ? 'https\/\/' : 'http:\/\/') + 'giphy.com/static/js/widgets/embed.js';var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(g, s);</script>";

        return GiphySearch.format( embed_str, {
            gif_id:gif_id
        })
    },
    /**
